...
| Project | What |
| --- | --- |
| [neo-deep-agent-lab](https://github.com/Shumatsurontek/neo-deep-agent-lab) | Deep agent SQL lab with Modal serverless deployment |
| [neo-neo-sn62](https://github.com/Shumatsurontek/neo-neo-sn62) | Bittensor SN62 — decentralized AI subnet mining & validation |
| [steering-research](https://github.com/Shumatsurontek/steering-research) | Where, how, and why activation steering works on instruction-tuned LLMs |
| [Gptq-Babai-Quantization](https://github.com/Shumatsurontek/Gptq-Babai-Quantization) | Visualization of GPTQ lattice reduction for weight quantization |
| [sparse-moe-torch](https://github.com/Shumatsurontek/sparse-moe-torch) | Sparse Mixture-of-Experts routing visualization |
